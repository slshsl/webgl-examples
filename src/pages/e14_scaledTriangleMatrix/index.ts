...
function main() {
    ...
    const u_ScalingMatrix = gl.getUniformLocation(program, 'u_ScalingMatrix');
    if (!u_ScalingMatrix) {
        console.log("Failed to get the storage location of u_ScalingMatrix");
        return;
    }

    gl.uniformMatrix4fv(u_ScalingMatrix, false, scalingMatrix);
